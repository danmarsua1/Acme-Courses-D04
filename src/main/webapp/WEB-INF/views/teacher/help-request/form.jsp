...
<acme:form>
	...
	<acme:input-textbox code="teacher.help-request.form.label.statement" path="statement"/>
	<acme:input-textbox code="teacher.help-request.form.label.creationMoment" path="creationMoment"/>
	<acme:input-textbox code="teacher.help-request.form.label.initDate" path="initDate"/>
	<acme:input-textbox code="teacher.help-request.form.label.finishDate" path="finishDate"/>
	...
	<acme:input-textbox code="teacher.help-request.form.label.link" path="link"/>
</acme:form>
