/*
 * LearnerFollowUpCreateService.java
 *
...
import acme.features.learner.helpRequest.LearnerHelpRequestRepository;
...
public class LearnerFollowUpCreateService implements AbstractCreateService<Learner, FollowUp> {
	...
	@Autowired
	protected LearnerHelpRequestRepository helpRequestRepository;
